...
- [x] T004 [N] กลาง × plan-2 vs v2×แผน
  - ✅ กลาง 121,266 vs v2×แผน 186,105 (4 รายการ) = +64,839 (+53%) — **revise 19/07:** กลาง **102,906** (สีเทา 61.2) vs v2×แผน **155,505** = +52,599 (+51%)
- [x] T005 [N] รายการใหม่
  - ✅ ซัมโน้นดำ 250/ตร.ม. เทียบแผ่นทางเดินได้ · ค่าบริการ 6,000 ควรอยู่ในเหมาเดิมหรือแจกแจง
- [x] T006 [N] HTML + summary.html
  - ✅ qt-v2/comparison.html · summary.html §4b · sync สีเทา 61.2 (19/07)
- [x] T007 [N] สรุปภาษาไทย
  - ✅ § Results ด้านล่าง

## Results

**วันที่วิเคราะห์:** 13/07/2569 · **revise สีเทา:** 19/07/2569

### สรุป: v2 สมเหตุสมผลแค่ไหน?

**ปานกลาง–สูง** — ดีขึ้นจาก v1 เรื่องความชัดของพื้นที่หญ้าและสเปกคอนกรีต แต่ **ยอดรวมยังสูงกว่าราคากลางมาก** โดยเฉพาะปูพื้น 1,500/ตร.ม. (สมเหตุสมผลถ้า SCG UVT)

| ฐานเปรียบเทียบ | ยอด | ส่วนต่างจาก v2 |
|----------------|-----|----------------|
| ราคากลาง × plan-2 (4 รายการ) | **102,906** | สีเทา 61.2 · เลิกใช้ 121,266 |
| ราคากลาง × จำนวน v2 (5 รายการ) | 146,610 | **+81,865 (+56%)** |
| v2 หน่วย × plan-2 (4 รายการ) | **155,505** | |
| สีเทาบริษัท vs แผน | 75 vs 61.2 | +13.8 ≈ +14 ตร.ม. |
| **v2 รวม** | **228,475** | — |
...
| คอนกรีต / สีเทา | ส่วนเพิ่มบริษัท 75 vs แผน 61.2 (~+14) · หน่วย 750 สูงกว่ากลาง 10 cm |
...
- **เป้าหมายต่อรอง:** กลาง × plan-2 ≈ **102,906** (+ ทางลาด + แผ่นทางเดิน/ขอบกั้นดินตามจริง)
...
| พื้นที่ตามสี | [qt-v1/area-breakdown.md](../resources/quotation/qt-v1/area-breakdown.md) |
